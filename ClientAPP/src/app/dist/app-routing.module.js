...
var routes = [
    { path: '', component: home_component_1.HomeComponent, data: { breadcrumb: 'Home' } },
    ...
    { path: 'test-errors', component: test_error_component_1.TestErrorComponent },
    ...
    },
    {
        ...
        loadChildren: function () {
            return Promise.resolve().then(function () { return require('./basket/basket.module'); }).then(function (m) { return m.BasketModule; });
        }
    },
    {
        path: 'checkout',
        ...
        loadChildren: function () {
            return Promise.resolve().then(function () { return require('./checkout/checkout.module'); }).then(function (m) { return m.CheckoutModule; });
        }
    },
    {
        path: 'account',
        loadChildren: function () {
            return Promise.resolve().then(function () { return require('./account/account.module'); }).then(function (m) { return m.AccountModule; });
        }
    },
     {
        path: 'orders', canActivate: [auth_guard_1.authGuard],
        loadChildren: function () {
