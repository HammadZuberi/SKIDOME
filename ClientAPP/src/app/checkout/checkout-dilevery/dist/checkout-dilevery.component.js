...
var CheckoutDileveryComponent = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], CheckoutDileveryComponent.prototype, "checkoutForm");
    CheckoutDileveryComponent = __decorate([
        core_1.Component({
    ...
    return CheckoutDileveryComponent;
}());
exports.CheckoutDileveryComponent = CheckoutDileveryComponent;
